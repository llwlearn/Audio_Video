...
static constexpr auto qt_meta_stringdata_CLASSUserInfoENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "onLogOutClicked",
    "onPersonalInformationSettingsClicked"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUserInfoENDCLASS_t qt_meta_stringdata_CLASSUserInfoENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 18),  // "onMyMembersClicked"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 15),  // "onLogOutClicked"
        QT_MOC_LITERAL(45, 36)   // "onPersonalInformationSettings..."
    },
    "UserInfo",
    "onMyMembersClicked",
    "",
...
Q_CONSTINIT const QMetaObject UserInfo::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUserInfoENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onPersonalInformationSettingsClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void UserInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onMyMembersClicked(); break;
        case 1: _t->onLogOutClicked(); break;
        case 2: _t->onPersonalInformationSettingsClicked(); break;
        default: ;
        }
    }
    (void)_a;
